...
using DataFrames
params = DataFrame(names=["a₀", "d₀", "r₁", "r₀", "α₀","α₁", "k",  "β", "δₒ",  "aₐ",    "a₂","d₂","k₂","ϕ₀","ϕ₁", "r₂","rᵦ","δₜ", "ζ₁", "ζ₀","η₁", "η₀" ,"k₃"],
                values=[100000, 1000, 100000,  1000,  0,  0.2,  0.5,  0.1,   0.09,  100, 100, 100,  100, 0,   0.5, 1e5,  1e3,  0.0693,  100,  100, 100, 100, 100])
